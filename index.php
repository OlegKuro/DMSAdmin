...
<div class="container">
    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3" style="margin: 80px auto">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title text-center">AdminStats</div>
            </div>

            <div class="panel-body">

                <form name="form" id="form" class="form-horizontal" action="auth.php" enctype="multipart/form-data"
                      method="POST">

                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user-circle-o" aria-hidden="true"></i></span>
                        <input id="user" type="text" class="form-control" name="login" value="" placeholder="Nickname">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 controls">
                            <button type="submit" href="#" class="btn btn-primary pull-right"><i
                                        class="glyphicon glyphicon-log-in"></i>Войти
                            </button>
                        </div>
                    </div>
...
<small id="smallauth" style="top: -72px;
